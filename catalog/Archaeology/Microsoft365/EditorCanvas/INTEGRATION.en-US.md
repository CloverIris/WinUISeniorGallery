...
Depend on experiences.editor-canvas; only Archaeology/Gallery points to stable modules and stable modules never reference the exhibit. This exhibit owns only historical research, modernization notes, and Gallery demo specification; stable implementation is owned by experiences.editor-canvas (EditorCanvasExperience).
