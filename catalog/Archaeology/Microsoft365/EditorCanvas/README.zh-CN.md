...
本展项只拥有历史研究、现代化说明和 Gallery 演示规格；稳定实现由 experiences.editor-canvas（EditorCanvasExperience）拥有。 不提交 Office/Microsoft 365 原始截图、图标、字体或品牌素材。

## 文档

- SPEC：原始体验、设计基因与现代范围
- DESIGN：视觉、输入与无障碍取舍
- INTEGRATION：稳定依赖和服务边界
- ACCEPTANCE：研究与交互验收
- SOURCES：证据和版权状态
