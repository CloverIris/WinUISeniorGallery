...
This exhibit owns only historical research, modernization notes, and Gallery demo specification; stable implementation is owned by experiences.editor-canvas (EditorCanvasExperience). No original Office/Microsoft 365 screenshot, icon, font, or brand asset is committed.

## Documents

- SPEC: original experience, design DNA, and modern scope
- DESIGN: visual, input, and accessibility tradeoffs
- INTEGRATION: stable dependency and service boundary
- ACCEPTANCE: research and interaction acceptance
- SOURCES: evidence and copyright state
