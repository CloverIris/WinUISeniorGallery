...
This exhibit owns only historical research, modernization notes, and Gallery demo specification; stable implementation is owned by experiences.people-card (PeopleCard). No original Office/Microsoft 365 screenshot, icon, font, or brand asset is committed.
