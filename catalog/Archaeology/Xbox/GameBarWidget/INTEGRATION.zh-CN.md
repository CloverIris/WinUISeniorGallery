...
依赖 experiences.game-bar-widget，仅从 Archaeology/Gallery 指向稳定模块，稳定模块不得反向引用本展项。本展项只拥有历史研究、现代化说明和 Gallery 演示规格；稳定实现由 experiences.game-bar-widget（GameBarWidgetExperience）拥有。
