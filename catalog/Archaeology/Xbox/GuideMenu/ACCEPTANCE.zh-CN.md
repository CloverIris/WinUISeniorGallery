...
三层导航中连续按 B/Esc 必须逐层返回并最终恢复视频表面原焦点；打开菜单不暂停媒体，除非宿主策略明确要求。

## 输入、无障碍与性能

D-pad/摇杆纵向导航、肩键换区、A 进入、B 返回；鼠标、键盘和触摸具有等价路径。 Light、Dark、High Contrast、Reduced Motion、RTL、100%–300% DPI 均可完成核心路径。演示不得持续轮询或后台联网，关闭后无计时器、事件或窗口泄漏。
