...
本展项只拥有历史研究、现代化说明和 Gallery 演示规格；稳定实现由 experiences.guide-menu（GuideMenuExperience）拥有。 不提交原始截图、声音、图标或品牌资产。

## 文档

- SPEC：原始交互与现代范围
- DESIGN：保留、改造与无障碍
- INTEGRATION：稳定实现映射与资源边界
- ACCEPTANCE：可验证的研究和体验标准
- SOURCES：出处、访问日期与版权状态
