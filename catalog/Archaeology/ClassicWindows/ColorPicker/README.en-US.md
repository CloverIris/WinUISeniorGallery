...
This exhibit owns only historical research, modernization notes, and Gallery demo specification; stable implementation is owned by controls.color-picker-ex (ColorPickerEx). No historical Windows screenshot, icon, font, sound, or extracted resource is committed.
