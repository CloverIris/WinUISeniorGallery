...
Depend on controls.color-picker-ex and allow only Archaeology/Gallery to point to stable modules. This exhibit owns only historical research, modernization notes, and Gallery demo specification; stable implementation is owned by controls.color-picker-ex (ColorPickerEx).
