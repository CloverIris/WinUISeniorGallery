...
依赖 controls.search-box-ex，只允许 Archaeology/Gallery 指向稳定模块。本展项只拥有历史研究、现代化说明和 Gallery 演示规格；稳定实现由 controls.search-box-ex（SearchBoxEx）拥有。
