...
依赖 controls.breadcrumb-bar-ex，只允许 Archaeology/Gallery 指向稳定模块。本展项只拥有历史研究、现代化说明和 Gallery 演示规格；稳定实现由 controls.breadcrumb-bar-ex（BreadcrumbBarEx）拥有。
