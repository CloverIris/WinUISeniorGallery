...
This exhibit owns only historical research, modernization notes, and Gallery demo specification; stable implementation is owned by controls.breadcrumb-bar-ex (BreadcrumbBarEx). No historical Windows screenshot, icon, font, sound, or extracted resource is committed.

## Documents

- SPEC: original experience and modern boundary
- DESIGN: preservation, adaptation, and accessibility
- INTEGRATION: stable dependency and platform boundary
- ACCEPTANCE: research and behavior acceptance
- SOURCES: provenance and asset state
