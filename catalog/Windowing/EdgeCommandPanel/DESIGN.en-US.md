# EdgeCommandPanel Design

## Visual Hierarchy and Responsive Behavior

Candidate tree: Scrim, PanelRoot, DragHandle, CommandItemsRepeater, Header/FooterPresenter, FocusSentinel. Narrow/regular/wide and 100%–300% DPI share one state model; Window change never rebuilds host data and 200% text uses reflow/overflow.

## Input and Focus

Explicit button, keyboard, and touch handle open; Escape/B closes innermost, and edge gesture exists only in app-declared zone without system conflict.
