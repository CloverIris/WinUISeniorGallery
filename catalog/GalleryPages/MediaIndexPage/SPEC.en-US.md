...
- Data source: Media catalog + related experiences
- Included entries: media, experience
...
- Route: `/media`
- Allowed parameters: `feature, capability`
...
- retain media architecture guidance without creating a player.
...
- Primary command will open the media specification route.
