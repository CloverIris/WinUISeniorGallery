...
- Data source: IGallerySettingsStore + validated defaults
- Included entries: local setting
...
- show every default instead of an empty page.
...
- Primary command will update window preview and asynchronously persist the validated value.
