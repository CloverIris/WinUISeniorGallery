...
- Data source: Feature Catalog + asset manifest
- Included entries: control, experience, archaeology
...
- Route: `/`
- Allowed parameters: `section, feature`
...
- retain the product statement and fixed category entries when the catalog is empty.
...
- Primary command will open the featured entry's canonical route.
