...
- Canonical route: `/playground`
- Route provider: `route.gallery.playground`
- Data source: window-scoped Demo Registry
- Included entries: registered demo
...
- Route: `/playground`
- Allowed parameters: `demo_id, theme, input`
...
- show the demo picker and security boundary.
...
- Primary command will instantiate an allow-listed demo factory and commit typed properties.
