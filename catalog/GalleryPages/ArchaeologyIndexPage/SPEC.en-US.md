# ArchaeologyIndexPage Specification

## Metadata and invariants

- Feature ID: `pages.archaeology-index-page`
- Canonical route: `/archaeology`
- Route provider: `route.gallery.archaeology`
- Data source: Archaeology Catalog + SOURCES + license manifest
- Included entries: archaeology
...
- Route: `/archaeology`
- Allowed parameters: `period, product, source, license`
...
- retain the non-affiliation notice, research method, and filter summary.
...
- Primary command will open local research; external links require another explicit action.
