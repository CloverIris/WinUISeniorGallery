...
- Data source: assembly metadata + LICENSE + notice manifest
- Included entries: legal/build metadata
...
- show unknown for missing metadata while retaining License and non-affiliation notice.
...
- Primary command will view local legal text, copy allow-listed diagnostics, or explicitly open a link.
