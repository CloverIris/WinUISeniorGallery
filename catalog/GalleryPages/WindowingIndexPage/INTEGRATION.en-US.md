...
- enumerate no other process windows and request no system permission.
...
- Empty: retain capability summary without creating another window.
- Error: show Retry, Return home, and correlation ID.
- Permission/capability: enumerate no other process windows and request no system permission.
