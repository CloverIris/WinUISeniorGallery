# ExperiencesIndexPage Specification

## Metadata and invariants

- Feature ID: `pages.experiences-index-page`
- Canonical route: `/experiences`
- Route provider: `route.gallery.experiences`
- Data source: Feature Catalog kind=experience + dependency graph
- Included entries: experience
...
- Route: `/experiences`
- Allowed parameters: `category, input, maturity`
...
- show category guidance and Clear filters.
...
- Primary command will open the experience specification and enable Run only when dependencies are complete.
