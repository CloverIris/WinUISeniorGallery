# QuickResumeExperience Acceptance
...
## Given / When / Then
Given expired/corrupt/user switch, old image never leaks and item can remove; 100 items virtualize, repeated resume calls provider once.
