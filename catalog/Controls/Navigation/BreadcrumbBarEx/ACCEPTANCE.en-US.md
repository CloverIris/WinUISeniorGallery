...
## Automated scenarios
Cover root/long/invalid paths, 1,000-segment overflow, edit cancel, suggestion races, RTL, and drag; stale queries never replace new results.
